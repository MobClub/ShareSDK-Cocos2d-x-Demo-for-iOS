...
namespace cn
{
    namespace sharesdk
    {
        ...
        public:
            ...
            static void showShareMenu(C2DXArray *platTypes, C2DXDictionary *content, int x, int y, C2DXShareResultEvent callback);
             ...
             *	@param 	callback 	回调方法
             */
            static void showShareView(C2DXPlatType platType, C2DXDictionary *content, C2DXShareResultEvent callback);
             ...
             *	@param  account     用户名
             */
            static void getFriendList(C2DXPlatType platType, int count, int page, C2DXGetFriendsResultEvent callback);
             ...
             *	@param 	account 	呢称
             */
            static void addFriend(C2DXPlatType platType, const char* account, C2DXAddFriendResultEvent callback);
